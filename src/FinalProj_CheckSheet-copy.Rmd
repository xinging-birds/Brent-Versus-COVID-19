...
(A) .Rmd Line numbers where at least two different data sources are imported: 30, 86


(B) .Rmd Line numbers for inspecting data intake: 68, 98
...
(A) .Rmd Line number(s) for general data wrangling: 119-122


(B) .Rmd Line number(s) for a join operation: 48-57


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 32-45, 205-207


(D) .Rmd Line number(s) for use of regular expressions: 62


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 122


(F) .Rmd Line number(s) for use of user-defined functions: 234-265 (definition), 289, 328, 369 (implementation)


(G) .Rmd Line number(s) for use of loops and/or control flow: NA


(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): NA
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 124 (line), 154 (candlestick), 209 (boxplot), 210 (density), 222 (area)

(B) .Rmd Line number(s) for use of multiple aesthetics: 211 (facet wrap), 422 (color)

(C) .Rmd Line number(s) for use of layered graphics: 296, 335, 376 (logistic model), 424 (smoother)

(D) .Rmd Line number(s) for use of leaflet maps: NA   

(E) .Rmd Line number(s) for use of decision tree or dendogram results: NA
